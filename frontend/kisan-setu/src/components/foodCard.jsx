...
const newQty=quantity-1
  ...
  return (
    <div className='w-[250px] rounded-2xl border-2 border-white bg-white shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col'>
...
<span className='font-bold text-gray-900 text-lg'>
  ₹{data.price} {data.unit ? `/ ${data.unit}` : ""}
</span>
