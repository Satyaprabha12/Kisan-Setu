...
function CategoryCard({name,image,onClick}) {
  return (
    <div className='w-[120px] h-[120px] md:w-[500px] md:h-[400px] rounded-2xl border-2 border-white shrink-0 overflow-hidden bg-white shadow-xl hover:shadow-lg transition-shadow relative' onClick={onClick}>
