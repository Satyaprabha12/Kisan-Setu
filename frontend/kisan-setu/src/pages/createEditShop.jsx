      ...
      <div className="max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100">
        <div className="flex flex-col items-center mb-6">
          <div className="bg-orange-100 p-4 rounded-full mb-4">
            <PiGrainsDuotone className="text-orange-500 w-16 h-16" />
          </div>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <button
            className="w-full bg-orange-500 text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:bg-orange-600 hover:shadow-lg transition-all duration-200 cursor-pointer"
            disabled={loading}
          >
